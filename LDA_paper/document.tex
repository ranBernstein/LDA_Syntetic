...
\end{equation}
\\\\and if $\Delta_s, \delta_x$, and $\delta_y$ are the drift vectors, we get:
...
\\\\By Cauchy–Schwarz inequality we get:
\\$\parallel B_0^{-1}\delta w_0\parallel \ \leq \ \parallel B_0^{-1}\delta \parallel \parallel w_0\parallel
\\\parallel B_0^{-1}\Delta\parallel \ \leq \ \parallel B_0^{-1}L\parallel +\parallel  B_0^{-1}Q\parallel$
\\\\So we can derive the new (convex?!) condition:
\\ $\parallel B_0^{-1}\delta \parallel + \ \parallel B_0^{-1}\delta \parallel \parallel w_0\parallel + R_0( \parallel B_0^{-1}L\parallel +\parallel  B_0^{-1}Q\parallel) \ \leq \ R_0$
